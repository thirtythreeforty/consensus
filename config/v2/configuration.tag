<configure-appearance>
	<configuration-container title="Appearance">
		<configuration-content>
			<configuration-toggle inputid='disp_second_hand'>
				Second hand
		...
		<configuration-content>
			<configuration-toggle inputid='disp_no_connection'>
				"No connection" icon
			</configuration-toggle>
		</configuration-content>
		<configuration-footer>
...
<configure-notifications>
	<configuration-container title='Notifications'>
		<configuration-content>
			<configuration-toggle inputid='vibrate_on_hour'>
				Vibrate on the hour
			</configuration-toggle>
		</configuration-content>
		<configuration-footer>
		...
		<configuration-content>
			<configuration-toggle inputid='vibrate_on_disconnect'>
